      ...
      <Box>
        ...
        <FlexBox>
          ...
          <SkillBox bgColor={Colors.DARKBLUE} fontSize={30} rowSize={7} title="RPG Maker" subtitle="GAME">
            초등학교 때 가족이 rpg maker 툴을 알려주며, 이걸 통해 해리포터 게임을 함께 만들자고 제안했습니다. 완성은 하지 못했지만 여러 버튼을 눌러보며 스스로 게임 개발 방법을 배웠고, 간단한 이벤트 기반 쯔꾸르 앱을 만들 수 있었습니다.<br/><br/>코딩에 익숙해지고 나서 다시 사용했을 때는 텍스트 코딩을 통한 더 세세한 조정법을 배워 학생과 함께 게임을 만들어 보기도 했습니다.
          </SkillBox>
